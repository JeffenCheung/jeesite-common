...
COMMENT ON COLUMN oa_leave.del_flag IS '删除标记（0：正常；1：删除；2：审核）';
...
COMMENT ON COLUMN oa_notify.del_flag IS '删除标记（0：正常；1：删除；2：审核）';
...
COMMENT ON COLUMN OA_TEST_AUDIT.del_flag IS '删除标记（0：正常；1：删除；2：审核）';
