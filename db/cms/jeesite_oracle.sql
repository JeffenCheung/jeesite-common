...
COMMENT ON COLUMN cms_article.del_flag IS '删除标记（0：正常；1：删除；2：审核）';
...
COMMENT ON COLUMN cms_category.del_flag IS '删除标记（0：正常；1：删除；2：审核）';
...
COMMENT ON COLUMN cms_comment.del_flag IS '删除标记（0：正常；1：删除；2：审核）';
...
COMMENT ON COLUMN cms_guestbook.del_flag IS '删除标记（0：正常；1：删除；2：审核）';
...
COMMENT ON COLUMN cms_link.del_flag IS '删除标记（0：正常；1：删除；2：审核）';
...
COMMENT ON COLUMN cms_site.del_flag IS '删除标记（0：正常；1：删除；2：审核）';
