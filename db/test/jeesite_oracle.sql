...
COMMENT ON COLUMN test_data.del_flag IS '删除标记（0：正常；1：删除；2：审核）';
COMMENT ON COLUMN test_data.tags IS '标签';
...
COMMENT ON COLUMN test_data_child.del_flag IS '删除标记（0：正常；1：删除；2：审核）';
...
COMMENT ON COLUMN test_data_main.del_flag IS '删除标记（0：正常；1：删除；2：审核）';
...
COMMENT ON COLUMN test_tree.del_flag IS '删除标记（0：正常；1：删除；2：审核）';
