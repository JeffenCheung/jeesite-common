...
public class UserController extends BaseController {
	...
	public User get(@RequestParam(required=false) String id) {
		...
		if (StringUtils.isNotBlank(id)){
		    ...
		    dict = dictService.get(user.getFloor().getId());}
			if(dict!=null){
				user.setFloor(dict);
			}
		}
	 ...
	 * @return
	 */
	@RequestMapping(value = "getLoginNameList", method = RequestMethod.GET)
	public @ResponseBody List<User> getLoginNameList(@RequestParam("term") String query) {
		User user = new User();
		user.setLoginName(query);
		List<User> loginNameList= systemService.findUser(user);
	...
	public @ResponseBody List<User> getTitleList(@RequestParam("term") String query) {
		User user = new User();
		user.setName(query);
		List<User> titleList= systemService.findUser(user);
		return titleList;
	}
	...
	public String form(User user, Model model) {
		...
		if (user.getPost()==null || user.getPost().getId()==null){
			user.setPost(UserUtils.getUser().getPost());
		}
	...
	public String save(User user, HttpServletRequest request, Model model, RedirectAttributes redirectAttributes) {
		...
		user.setPost(new Post(request.getParameter("post.id")));
		// 如果新密码为空，则不更换密码
	...
	public String info(User user, HttpServletResponse response, Model model) {
		...
		if (StringUtils.isNotBlank(user.getName())){
			...
			currentUser.setTags(user.getTags());
	...
	public String clearCache(RedirectAttributes redirectAttributes) {
		systemService.clearCacheOfAllUsers();
		addMessage(redirectAttributes, MutiLangUtils.getLang("common.refresh.success"));
		return "redirect:"+Global.getAdminPath()+"/sys/user/list";
	}
