...
//	}
	 ...
	 * @since v1.2.10
	 */
	public static List<com.thinkgem.jeesite.modules.sys.entity.UserEntity> toActivitiNodeUser(
			List<User> userList) {
		List<com.thinkgem.jeesite.modules.sys.entity.UserEntity> list = new ArrayList<com.thinkgem.jeesite.modules.sys.entity.UserEntity>();
		...
		for (int i = 0; i < userList.size(); i++) {
			...
			com.thinkgem.jeesite.modules.sys.entity.UserEntity userEntity = new com.thinkgem.jeesite.modules.sys.entity.UserEntity();
			userEntity.setId(user.getLoginName());
			...
			userEntity.setOfficeName(user.getOffice() == null ? null : user
					.getOffice().getName());
			userEntity.setPostId(user.getPost() == null ? null : user.getPost()
					.getId());
			userEntity.setPostName(user.getPost() == null ? null : user
					.getPost().getPostName());
			userEntity.setFloorId(user.getFloor() == null ? null : user
					.getFloor().getValue());
