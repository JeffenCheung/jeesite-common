...
public abstract class BaseController {
	 ...
	 * @param messages
	 */
	private StringBuilder messageditor(String... messages){
	...
	protected void addMessage(RedirectAttributes redirectAttributes, String... messages) {
		// fixed message show NG: escape html by jeffen@pactera 2015/6/11
		//redirectAttributes.addFlashAttribute("message", sb.toString());
		//redirectAttributes.addFlashAttribute("message", Encodes.escapeHtml(sb.toString()));
		redirectAttributes.addFlashAttribute("message", messageditor(messages).toString().replaceAll("\"", "'").replaceAll("\\\\","/"));
	}
